...
<div class="wrapper l-horizontal">
    @include('dashboard.user_layouts.administrator.layouts.header')
    <div class="content-page salon2-content">
        @include('dashboard.user_layouts.administrator.layouts.navigation')
        @yield('content')
    </div>
</div>
<!-- Wrapper End-->
@include('dashboard.user_layouts.administrator.layouts.footer')
