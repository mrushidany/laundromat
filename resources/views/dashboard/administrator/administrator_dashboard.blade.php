                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div id="trending-order-slick-arrow" class="slick-aerrow-block"></div>
                        </div>
                        <div class="card-body">
                            <div class="salone-styles">
                                <div class="item">
                                    ...
                                    <div class="odr-content bg-danger-light">
                                        ...
                                        <ul class="list-unstyled  mt-2 mb-0">
                                            <li class="bg-white rounded-small iq-card-icon-small mr-3">
                                                <a href="javascript:void(0);"><i class="lab la-facebook-f text-primary"></i></a>
                                            </li>
                                            <li class="bg-white rounded-small iq-card-icon-small mr-3">
                                                <a href="javascript:void(0);"><i class="lab la-twitter text-info"></i></a>
                                            </li>
                                            <li class="bg-white rounded-small iq-card-icon-small mr-3">
                                                <a href="javascript:void(0);"><i class="lab la-instagram  text-danger"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="rounded-circle avatar-120 bg-white odr-img">
                                        <img src="{{asset('assets/images/layouts/layout-12/03.png')}}" class="img-fluid m-auto" alt="image">
                                    </div>
                                    <div class="odr-content bg-info-light">
                                        <h5>Malinda</h5>
                                        <p class="mt-2">Wash Man</p>
                                        <ul class="list-unstyled  mt-2 mb-0">
